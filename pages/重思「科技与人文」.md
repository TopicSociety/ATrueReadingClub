...
:heading: true
:END:
### 因为史蒂夫·乔布斯（Steve Jobs），很多人知道了「技术与人文」（Technology and Liberal Art）这个词／概念。但是很多数人同时也会把这个概念局限在乔布斯以及苹果公司的这个语境里，并将之翻译为「工程与设计」，认为这是要把人性的美丽与温度，注入坚硬与冰冷的技术。更有甚者，则把这一理念庸俗化为某种「情怀」
